...
public class Policy {
	...
	private String namespace; //policy가 적용될 수 있는 namespace 범위 //label 
	private Map<String, String> labels = null; //라벨이 여러개일테니 key,value로 나타내기 위해 Map사용

	private IngressEgressPolicy egress;
	private IngressEgressPolicy ingress;
	...
	public String toString() {
		return "Policy [name=" + name + ", namespace=" + namespace + ", labels=" + labels + ", egress=" + egress
				+ ", ingress=" + ingress + "]";
	}
	...
	public IngressEgressPolicy getIngress() {
		return ingress;
	}
	public void setIngress(IngressEgressPolicy ingress) {
	...
	public IngressEgressPolicy getEgress() {
		return egress;
	}
	public void setEgress(IngressEgressPolicy egress) {
		this.egress = egress;
	}
